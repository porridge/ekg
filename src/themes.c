...
void init_theme()
{
	...
	add_format("message_header", "%g.--- %nWiadomo¶æ od %1 %c(%C%#%c/%2)%n %g--- -- -\n", 1);
	add_format("message_footer", "%g`----- ---- --- -- -%n\n", 1);
	add_format("message_line_prefix", "%g|%n ", 1);
	add_format("message_line_suffix", "\n", 1);
	add_format("message_line_width", "75", 1);
	add_format("chat_header", "%c.--- %nRozmowa z %1 %c(%C%#%c/%2)%n %c--- -- -\n", 1);
	add_format("chat_footer", "%c`----- ---- --- -- -%c\n", 1);
	add_format("chat_line_prefix", "%c|%n ", 1);
	add_format("chat_line_suffix", "\n", 1);
