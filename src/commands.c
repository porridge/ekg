...
struct command commands[] = {
  {"add", "U??", command_add, " <numer> <alias> [opcje]",
   "Dodaje u¿ytkownika do listy kontaktów",
   "Opcje identyczne jak dla polecenia %Wmodify%n"},
  {"alias", "??", command_alias, " [opcje]", "Zarz±dzanie aliasami",
   "  -a, --add <alias> <komenda>\n  -d, --del <alias>\n  [-l, --list]\n"},
  {"away", "?", command_away, " [powód]", "Zmienia stan na zajêty", ""},
  {"back", "", command_away, "", "Zmienia stan na dostêpny", ""},
  {"change", "?", command_change, " <opcje>",
   "Zmienia informacje w katalogu publicznym",
   "  -f, --first <imiê>\n  -l, --last <nazwisko>\n  -n, --nick <pseudonim>\n  -e, --email <adres>\n  -b, --born <rok urodzenia>\n  -c, --city <miasto>\n  -F, --female  \n  -M, --male"},
  {"chat", "u?", command_msg, " <numer/alias> <wiadomo¶æ>",
   "Wysy³a wiadomo¶æ w ramach rozmowy", ""},
  {"cleartab", "", command_cleartab, "", "Czy¶ci listê nicków do dope³nienia",
   ""},
  {"connect", "", command_connect, "", "£±czy siê z serwerem", ""},
  {"dcc", "duf", command_dcc, " [opcje]", "Obs³uga bezpo¶rednich po³±czeñ",
   "  send <numer/alias> <¶cie¿ka>\n  get [numer/alias]\n  close [numer/alias/id]\n  show\n"},
  {"del", "u", command_del, " <numer/alias>",
   "Usuwa u¿ytkownika z listy kontaktów", ""},
  ...
  {"find", "u", command_find, " [opcje]", "Interfejs do katalogu publicznego",
   "  -u, --uin <numerek>\n  -f, --first <imiê>\n  -l, --last <nazwisko>\n  -n, --nick <pseudonim>\n  -c, --city <miasto>\n  -b, --born <min:max>\n  -p, --phone <telefon>\n  -e, --email <e-mail>\n  -a, --active\n  -F, --female\n  -M, --male\n  --start <od>"},
/*	{ "info", "u", command_find, " <numer/alias>", "Interfejs do katalogu publicznego", "" }, */
  {"help", "c", command_help, " [polecenie]",
   "Wy¶wietla informacjê o poleceniach", ""},
  {"?", "c", command_help, " [polecenie]", "Synonim dla %Whelp%n", ""},
  {"ignore", "u", command_ignore, " [numer/alias]",
   "Dodaje do listy ignorowanych lub j± wy¶wietla", ""},
  {"invisible", "", command_away, "", "Zmienia stan na niewidoczny", ""},
  {"list", "u?", command_list, " [alias|opcje]",
   "Zarz±dzanie list± kontaktów",
   "  -a, --active\n  -b, --busy\n  -i, --inactive\n  -w, --wait\n\n  -f, --first <imiê>\n  -l, --last <nazwisko>\n  -n, --nick <pseudonim>  // tylko informacja\n  -d, --display <nazwa>  // wy¶wietlana nazwa\n  -p, --phone <telefon>\n  -u, --uin <numerek>\n  -g, --group [+/-]<grupa>\n\n  -p, --put\n  -g, --get"},
  {"msg", "u?", command_msg, " <numer/alias> <wiadomo¶æ>",
   "Wysy³a wiadomo¶æ do podanego u¿ytkownika", ""},
  {"on", "?u?", command_on, " <zdarzenie|...> <numer/alias> <akcja>|clear",
   "Dodaje lub usuwa zdarzenie", ""},
  {"passwd", "??", command_passwd, " <has³o> <e-mail>",
   "Zmienia has³o i adres e-mail u¿ytkownika", ""},
  {"private", "", command_away, " [on/off]",
   "W³±cza/wy³±cza tryb ,,tylko dla przyjació³''", ""},
  {"query", "u", command_query, " <numer/alias>",
   "W³±cza rozmowê z dan± osob±", ""},
  {"reconnect", "", command_connect, "", "Roz³±cza i ³±czy ponownie", ""},
  {"register", "??", command_register, " <email> <has³o>",
   "Rejestruje nowy uin", ""},
  {"remind", "", command_remind, "", "Wysy³a has³o na skrzynkê pocztow±", ""},
  {"save", "", command_save, "", "Zapisuje ustawienia programu", ""},
  {"set", "v?", command_set, " <zmienna> <warto¶æ>",
   "Wy¶wietla lub zmienia ustawienia", ""},
  {"sms", "u?", command_sms, " <numer/alias> <tre¶æ>",
   "Wysy³a SMSa do podanej osoby", ""},
  {"status", "", command_status, "", "Wy¶wietla aktualny stan", ""},
  {"quit", "", command_quit, "", "Wychodzi z programu", ""},
  {"unignore", "i", command_ignore, " <numer/alias>",
   "Usuwa z listy ignorowanych osób", ""},
...
int
match_arg (char *arg, char shortopt, char *longopt)
{
  if (!arg || *arg != '-')
    return 0;
...
char *
known_uin_generator (char *text, int state)
{
...
char *
unknown_uin_generator (char *text, int state)
{
  static int index = 0, len;
...
char *
ignored_uin_generator (char *text, int state)
{
  static struct list *l;
  static int len;
  struct userlist *u;
...
char *
dcc_generator (char *text, int state)
{
...
char *
empty_generator (char *text, int state)
{
  return NULL;
}

char **
my_completion (char *text, int start, int end)
{
  struct command *c;
  char *params = NULL;
  ...
  if (start)
    {
	  ...
	  || !strncasecmp (rl_line_buffer, "/chat ", 6))
	{
	  word = 0;
  ...
  if (start)
      ...
      for (c = commands; c->name; c++)
	{
	  ...
	  char *cmd =
	    (*rl_line_buffer == '/') ? rl_line_buffer + 1 : rl_line_buffer;
...
{
  int status_table[4] =
    { GG_STATUS_AVAIL, GG_STATUS_BUSY, GG_STATUS_INVISIBLE,
GG_STATUS_BUSY_DESCR };
  ...
  if (!strcasecmp (name, "away"))
  ...
  else
    {
      ...
      if (!params[0])
	{
	  my_printf ((private_mode) ? "private_mode_is_on" :
		     "private_mode_is_off");
	  return 0;
	}
  ...
  config_status =
    status_table[away] | ((private_mode) ? GG_STATUS_FRIENDS_MASK : 0);
  ...
  if (!strcasecmp (name, "connect"))
    {
      if (sess)
	{
	  my_printf ((sess->state ==
		      GG_STATE_CONNECTED) ? "already_connected" :
		     "during_connect");
	  return 0;
	}
...
COMMAND (command_change)
{
  ...
  if (!r->first_name || !r->last_name || !r->nickname || !r->email || !r->city
      || !r->born)
    {
  ...
  if (!params[1])
    {
      ...
      my_printf ("user_info", u->first_name, u->last_name, u->nickname,
		 u->display, u->mobile, groups);
...
{
  struct list *l;
  int count = 0, show_all = 1, show_busy = 0, show_active = 0, show_inactive =
    0, j, page_wait = 0;
  char *tmp, **argv = NULL;
      ...
      if ((argv = array_make (params[j], " \t", 0, 1, 1)))
	{
	  ...
	  for (i = 0; argv[i]; i++)
	      ...
	      if (match_arg (argv[i], 'a', "active"))
		{
	      ...
	      if (match_arg (argv[i], 'i', "inactive")
		  || match_arg (argv[i], 'n', "notavail"))
		{
		  show_all = 0;
		  show_inactive = 1;
		}
  ...
  for (l = userlist; l; l = l->next)
	...
	case GG_STATUS_NOT_AVAIL_DESCR:
      ...
      if (show_all
	  || (show_busy
	      && (u->status == GG_STATUS_BUSY
		  || u->status == GG_STATUS_BUSY_DESCR)) || (show_active
							     && u->status ==
							     GG_STATUS_AVAIL)
	  || (show_inactive
	...
	{
	  my_printf (tmp, format_user (u->uin), inet_ntoa (in),
		     itoa (u->port), u->descr);
...
COMMAND (command_msg)
{
  ...
  put_log (uin, "%s,%ld,%s,%ld,%s\n", (chat) ? "chatsend" : "msgsend", uin,
	   (u) ? u->display : "", time (NULL), msg);
  ...
  if ((!params[0] || !params[1]) && !unset)
      ...
      for (l = variables; l; l = l->next)
	{
	  ...
	  if ((!arg || !strcasecmp (arg, v->name)) && v->display != 2)
		...
		{
		  my_printf ("variable", v->name,
			     (!v->
			      display) ? "(...)" : itoa (*(int *) (v->ptr)));
		}
	    }
	}
    }
...
COMMAND (command_dcc)
{
  ...
  if (!params[0] || !strncasecmp (params[0], "sh", 2))
    {				/* show */
      int pending = 0, active = 0;

      if (params[1] && params[1][0] == 'd')
	{			/* show debug */
	  for (l = transfers; l; l = l->next)
	    {
	      struct transfer *t = l->data;

	      my_printf ("dcc_show_debug", itoa (t->id),
			 (t->type == GG_SESSION_DCC_SEND) ? "SEND" : "GET",
			 t->filename, format_user (t->uin),
			 (t->dcc) ? "yes" : "no");
	    }
      ...
      for (l = transfers; l; l = l->next)
	{
	  ...
	  if (!t->dcc
	      || (t->dcc->state != GG_STATE_SENDING_FILE
		  || t->dcc->state != GG_STATE_GETTING_FILE))
	    {
	      if (!pending)
		{
	      ...
	      my_printf ((t->type ==
			  GG_SESSION_DCC_SEND) ? "dcc_show_pending_send" :
			 "dcc_show_pending_get", itoa (t->id),
			 format_user (t->uin),
      ...
      for (l = transfers; l; l = l->next)
	{
	  ...
	  if (t->dcc
	      ...
	      if (!active)
		{
	      ...
	      my_printf ((t->type ==
			  GG_SESSION_DCC_SEND) ? "dcc_show_active_send" :
			 "dcc_show_active_get", itoa (t->id),
			 format_user (t->uin), t->filename);
	    }
	}
  ...
  if (!strncasecmp (params[0], "se", 2))
      ...
      else
	{
	  ...
	  if (!
	      (d = gg_dcc_send_file (u->ip.s_addr, u->port, config_uin, uin)))
	    {
  ...
  if (!strncasecmp (params[0], "g", 1))
      ...
      for (t = NULL, l = transfers; l; l = l->next)
	{
	  ...
	  if ((u = userlist_find (t->uin, NULL)))
	    {
	      if (!strcasecmp (params[1], itoa (u->uin))
      ...
      if (!l || !t || !t->dcc)
	{
      ...
      if ((t->dcc->file_fd =
	   open (t->filename, O_WRONLY | O_CREAT, 0600)) == -1)
	{
...
COMMAND (command_test_watches)
{
  ...
  for (l = watches; l; l = l->next, no++)
	...
	case GG_SESSION_DCC_GET:
	  type = "DCC_GET";
	  break;
	case GG_SESSION_USERLIST_PUT:
	  type = "USERLIST_PUT";
	  break;
	case GG_SESSION_USERLIST_GET:
	  type = "USERLIST_GET";
	  break;
	case GG_SESSION_USER0:
	  type = "USER0";
	  break;
	case GG_SESSION_USER1:
	  type = "USER1";
	  break;
	case GG_SESSION_USER2:
	  type = "USER2";
	  break;
	...
	case GG_SESSION_USER4:
	  type = "USER4";
	  break;
	case GG_SESSION_USER5:
	  type = "USER5";
	  break;
	case GG_SESSION_USER6:
	  type = "USER6";
	  break;
	case GG_SESSION_USER7:
	  type = "USER7";
	  break;
	default:
	  type = "(unknown)";
	...
	case GG_CHECK_WRITE:
	  check = "W";
	  break;
	case GG_CHECK_READ | GG_CHECK_WRITE:
	  check = "RW";
	  break;
	default:
	  check = "?";
	...
	default:
      ...
      snprintf (buf, sizeof (buf),
		"%d: type=%s, fd=%d, state=%s, check=%s, id=%d, timeout=%d",
		no, type, s->fd, state, check, s->id, s->timeout);
...
COMMAND (command_test_fds)
{
  ...
  for (i = 0; i < 2048; i++)
	...
	sprintf (buf + strlen (buf), "file, inode %lu, size %lu", st.st_ino,
		 st.st_size);
...
COMMAND (command_passwd)
{
  ...
  if (!
      (h =
       gg_change_passwd (config_uin, config_password, params[0], params[1],
			 1)))
    {
...
COMMAND (command_on)
{
  ...
  if (!params[0] || !strncasecmp (params[0], "-l", 2))
      ...
      for (l = events; l; l = l->next)
	{
	  ...
	  my_printf ("events_list", format_events (ev->flags),
		     (ev->uin == 1) ? "*" : format_user (ev->uin),
		     ev->action);
	  count++;
	}
...
{
  char *cmd = NULL, *tmp, *p = NULL, short_cmd[2] = ".", *last_name =
    NULL, *last_params = NULL;
  struct command *c;
  ...
  for (c = commands; c->name; c++)
    if (!isalpha (c->name[0]) && strlen (c->name) == 1
	&& line[0] == c->name[0])
      {
