 ...
 *
 * przy asynchronicznym ¶ci±ganiu userlisty wypada³oby wywo³aæ t± funkcjê
 * po zauwa¿eniu zmianan na gg_http->fd.
 *
 *  - h - to co¶, co zwróci³a gg_userlist_get()
 *
 ...
 * gg_userlist_put()
 *
 * wysy³a listy kontaktów na serwera.
 *
 *  - uin - numerek,
 *  - passwd - has³o,
 ...
 *
 * przy asynchronicznym wysy³aniu userlisty wypada³oby wywo³aæ t± funkcjê
 * po zauwa¿eniu zmianan na gg_http->fd.
 *
